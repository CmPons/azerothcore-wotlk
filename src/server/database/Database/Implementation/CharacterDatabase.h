...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_INSTANCE_SAVES_WITH_PROGRESSION,
    CHAR_REP_INSTANCE_PROGRESSION_RESET,
    CHAR_DEL_INSTANCE_PROGRESSION_RESET,
    CHAR_SANITIZE_INSTANCE_PROGRESSION_RESET,
